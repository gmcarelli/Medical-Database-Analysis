...
public class Neo4j extends Database {
	...
	public Neo4j(String databaseName, String username, String password, String host, Integer port) {
		super(databaseName, username, password, host, port);
	}
	
	public Neo4j(String databaseName, String username, String password) {
		super(databaseName, username, password, "localhost", 7474);
	}

	public Neo4j(Properties properties) {
		super(properties);
	}
